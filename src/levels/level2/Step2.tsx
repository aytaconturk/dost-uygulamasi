  ...
  return (
    <div className="flex flex-col md:flex-row items-start justify-center gap-6 px-4 md:px-12 relative mt-0">
      ...
      <div className="text-lg text-gray-800 leading-relaxed max-w-xl">
        <h2 className="text-2xl font-bold text-purple-800 mb-4">2. Adım: İkinci Okuma</h2>
        <p className="mt-2 text-gray-800">Metni tekrar okuyup anlama ve akıcılığa odaklanıyoruz. Hazır olduğunda öğretmeninin yönergelerini izleyebilirsin.</p>
      </div>
    </div>
  );
}
