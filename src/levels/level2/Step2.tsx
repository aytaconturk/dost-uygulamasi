    ...
    <div className="flex-1 flex flex-col items-center justify-center">
      <div className="flex flex-col md:flex-row items-start justify-center gap-6 px-4 md:px-12 relative mt-0 max-w-4xl">
        ...
        <div className="text-lg text-gray-800 leading-relaxed max-w-xl">
          <h2 className="text-2xl font-bold text-purple-800 mb-4 text-center">2. Adım: Okuma hızı</h2>
          <p className="mt-2 text-gray-800">Okuduğun metindeki okuma hızını analiz ediyoruz ve sana geri bildirim sunuyoruz.</p>
        </div>
      </div>
    </div>
  );
